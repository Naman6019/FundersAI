// forked from design-sync lib/common.mjs — adds 'excludeSrcFiles' to
// CONFIG_KEYS so source-kit.mjs's fork can exclude next/image-coupled
// files (framework-runtime-only, can't run standalone) from the synced
...
export const CONFIG_KEYS = new Set([
  ...
  // forked: FundersAI addition — see .design-sync/overrides/source-kit.mjs
  'excludeSrcFiles',
]);
