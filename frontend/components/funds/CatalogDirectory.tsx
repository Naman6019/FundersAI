...
export function CatalogUnavailable({ title, breadcrumbs }: { title: string; breadcrumbs?: ReactNode }) {
...
export default function CatalogDirectory({ title, funds, breadcrumbs }: { title: string; funds: CatalogFund[] | null; breadcrumbs?: ReactNode }) {
  if (funds === null) return <CatalogUnavailable title={title} breadcrumbs={breadcrumbs} />;
