...
export const FlickeringGrid: React.FC<FlickeringGridProps> = ({
  ...
  useEffect(() => {
    ...
    const updateCanvasSize = () => {
      const newWidth = width || container.clientWidth || 800;
      const newHeight = height || container.clientHeight || 600;
    ...
    const animate = (time: number) => {
      if (gridParams && isInViewRef.current) {
        ...
        if (elapsed >= 65) { // Cap grid updates to ~15 FPS for 100% main thread smoothness
