        ...
        <AnimatePresence>
          {!isDismissed && (
            <motion.div
              ...
              className={cn("group rounded-lg border bg-white/[0.04] p-3 text-white border-white/10 shadow-[0_24px_90px_rgba(0,0,0,0.18)]", className)}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="absolute right-0 bottom-0 left-0 h-10 bg-gradient-to-b from-transparent to-white/[0.04]"
