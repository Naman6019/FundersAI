...
_REMOVABLE_WORDS = {
    'direct', 'regular', 'retail', 'growth', 'cumulative', 'idcw', 'dividend',
    'reinvestment', 'payout', 'payment', 'institutional', 'bonus', 'option', 'plan',
    'of', 'daily', 'weekly', 'half', 'yearly', 'annual', 'quarterly', 'monthly',
}
